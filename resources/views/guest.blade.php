    ...
    <div class="w-full h-fit flex flex-col items-center justify-center gap-4 my-8">
      ...
      <form action="{{ route('search.submenu') }}" method="POST" class="relative mb-3">
        ...
        <input 
          ...
          type="text" 
          id="keyword"
          class="block w-full border-0 border-b border-b-dlhk-green bg-transparent appearance-none py-3 pl-4 pr-12 text-base text-slate-900 placeholder:text-slate-600 focus:outline-none sm:text-sm sm:leading-6"
    ...
    <div class="w-4/5 mx-auto rounded-lg">
      ...
      <div class="bg-white py-4 px-4">
        <a href="/dataku/{{ $result->slug }}"
          class="text-xl text-dlhk-green hover:underline font-semibold uppercase"  
        >
